...
class EmployeeDetailsInDatabase extends JFrame {
    ...
    EmployeeDetailsInDatabase() {
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent a) {
                try {
                    ...
                    tx7.setText("Record can't be Inserted....Check datatypes and ensure ids are unique");
        ...
        t2 = new JTextField(25);            //to display whether record deleted or not
        ...
        det = new JLabel("Employee Details:");          //to display information of selected employee
